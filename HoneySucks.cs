...
{
	[ApiVersion(1, 22)]
	public class HoneySucks : TerrariaPlugin
	{
		...
		{
			Commands.ChatCommands.Add(new Command("honeysucks.admin.toggle", ToggleHoney, "thoney")
				{
